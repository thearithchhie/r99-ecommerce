<template>
  <div>
    <div class="flex justify-between items-center mb-6">
      ...
      <Button @click="openCreateModal">Create New Category</Button>
    </div>
    ...
    <div v-else-if="error" class="p-4 bg-red-50 text-red-700 rounded-md mb-6">
      <p>{{ error }}</p>
      <Button variant="outline" class="mt-2" @click="fetchCategories">Try Again</Button>
    </div>

    <!-- Categories List Table -->
    <div v-else-if="categories.length" class="bg-white shadow-md rounded-lg overflow-hidden">
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="category in categories" :key="category.id" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 whitespace-nowrap">{{ category.parent_category ? category.parent_category.name : '-' }}</td>
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex space-x-2">
                ...
                <Button variant="outline" size="sm" @click="deleteCategory(category)" class="text-red-600 hover:bg-red-50">
                  <Trash class="h-4 w-4" />
                </Button>
              </div>
            </td>
...
const openCreateModal = () => {
  toast.toast({
    title: 'Coming Soon',
    description: 'Create Category functionality will be implemented soon',
  });
};
...
const editCategory = (category: Category) => {
  toast.toast({
    title: 'Coming Soon',
    description: 'Edit Category functionality will be implemented soon',
  });
};
